...
const monthlyIncome = [
  ...
  { month: 'Feb', salary: 4000, freelance: 800, other: 0 },
  { month: 'Mar', salary: 4000, freelance: 600, other: 0 },
  { month: 'Apr', salary: 4500, freelance: 700, other: 0 },
  { month: 'May', salary: 4500, freelance: 500, other: 0 },
...
const recentIncome = [
  ...
  { source: 'Freelance Client B', amount: 300, date: 'Jun 12, 2026', category: 'Freelance' },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="p-6 bg-gradient-to-br from-purple-500 to-purple-600 text-white border-none shadow-xl">
          ...
          <div className="space-y-1">
            <p className="text-purple-100 text-sm font-medium">Average Monthly Growth</p>
