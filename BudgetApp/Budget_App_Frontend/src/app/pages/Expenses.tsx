...
const expenseCategories = [
  ...
  { name: 'Food', amount: 800, percentage: 20, icon: ShoppingCart, color: 'from-purple-500 to-purple-600', trend: '+5%' },
  { name: 'Transportation', amount: 500, percentage: 12.5, icon: Car, color: 'from-amber-500 to-amber-600', trend: '-2%' },
  { name: 'Utilities', amount: 300, percentage: 7.5, icon: Zap, color: 'from-emerald-500 to-emerald-600', trend: '0%' },
  { name: 'Entertainment', amount: 400, percentage: 10, icon: Coffee, color: 'from-rose-500 to-rose-600', trend: '+8%' },
  { name: 'Other', amount: 800, percentage: 20, icon: MoreHorizontal, color: 'from-gray-500 to-gray-600', trend: '+12%' },
];
