...
const savingsProgress = [
  ...
  { month: 'Mar', amount: 11300 },
  { month: 'Apr', amount: 12700 },
  { month: 'May', amount: 14100 },
  { month: 'Jun', amount: 15500 },
];
...
const savingsTips = [
  'You\'re saving 25.9% of your income - keep it up!',
  'Consider setting up automatic transfers to your savings.',
  'You\'re on track to reach your emergency fund goal by October!',
  'Tip: Review and reduce subscription services you don\'t use.',
];
...
export function Savings() {
  ...
  const overallProgress = ((totalSavings / totalGoals) * 100).toFixed(1);
